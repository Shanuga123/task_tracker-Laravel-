...
@section('contents')
    ...
    <div class="row">
        ...
        <div class="col mb-3">
            ...
            <input type="text" name="price" class="form-control" placeholder="Price" value="{{ $task->price }}" readonly>
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
            <label class="form-label">task_code</label>
            <input type="text" name="task_code" class="form-control" placeholder="Task Code" value="{{ $task->task_code }}" readonly>
        </div>
        <div class="col mb-3">
